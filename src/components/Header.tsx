...
const NavItem: React.FC<{ href: string; small?: boolean }> = ({ href, small, children }) => {
  return (
    <Link href={href}>
      <a className={`${small ? "text-gray-600" : "text-gray-400"} hover:text-gray-800 transition-all`}>{children}</a>
    </Link>
  );
};
  ...
  return windowSize.width && windowSize.width < 700 ? (
    <div className="flex justify-between items-center p-4 sticky top-0 bg-white shadow-md">
      ...
      <Link href={overrideTitleHref ?? "/"}>
        <a className="text-4xl text-primary ml-16">{overrideTitle ?? "Uros Stok"}</a>
      </Link>
      <div
        style={{
          position: "absolute",
      ...
      >
        ...
        >
          ...
          <div className="flex space-x-4 items-center">
            ...
            <NavItem small href="https://www.linkedin.com/in/uro%C5%A1-%C5%A1tok-a6434313b/">
    ...
    <div className="max-w-7xl mx-auto px-2">
      <div className="flex justify-between items-center py-5 mx-2 md:mx-8">
        <Link href={overrideTitleHref ?? "/"}>
          <a className="text-4xl text-primary">{overrideTitle ?? "Uros Stok"}</a>
        </Link>
